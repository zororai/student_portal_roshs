...
echo "Creating demo students and parents...\n";

// Get existing classes
$classes = Grade::all();

if ($classes->isEmpty()) {
    echo "No classes found. Please create classes first.\n";
    exit(1);
}
...
foreach ($demoStudents as $index => $studentData) {
    ...
    echo "Created student: {$studentData['name']} (Roll: {$rollNumber})\n";
}

echo "\nDemo data creation completed!\n";
echo "Students can login with email: rollnumber@roshs.co.zw, password: 12345678\n";
echo "Parents need to complete registration using their phone numbers.\n";
echo "\nAccess the student creation form at: http://student_portal_roshs.test/student-with-parents/create\n";
