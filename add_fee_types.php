...
foreach ($feeTypes as $feeType) {
    $exists = FeeType::where('name', $feeType['name'])->exists();
    ...
    if (!$exists) {
        ...
        echo "- Skipped (already exists): {$feeType['name']}\n";
        $skipped++;
    }
}

echo "\n✓ Successfully added {$added} new fee types!\n";
echo "- Skipped {$skipped} existing fee types\n";
