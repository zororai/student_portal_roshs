...
<div class="min-h-screen flex items-center justify-center bg-gray-100 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8">
        ...
        <form class="mt-8 space-y-6" action="{{ route('user.force-change-password.update') }}" method="POST">
            @csrf
            ...
            <div class="rounded-md shadow-sm -space-y-px">
                <div class="mb-4">
                    ...
                    <input id="password" name="password" type="password" required
                        class="appearance-none relative block w-full px-3 py-3 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-lg focus:outline-none focus:ring-blue-500 focus:border-blue-500 focus:z-10 sm:text-sm @error('password') border-red-500 @enderror"
            ...
            <div class="text-center">
                <a href="{{ route('logout.get') }}" class="text-sm text-gray-600 hover:text-gray-900">
                    Logout instead
                </a>
            </div>
        </form>
