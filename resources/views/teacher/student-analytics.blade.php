...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            ...
            @if($selectedClassId)
            <a href="{{ route('teacher.student-analytics') }}" class="inline-flex items-center px-4 py-2 bg-gray-100 hover:bg-gray-200 text-gray-700 text-sm font-medium rounded-lg transition-colors">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-4 mb-6">
        <form method="GET" action="{{ route('teacher.student-analytics') }}" id="termFilterForm" class="flex items-center space-x-4">
            @if($selectedClassId)
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        ...
        <a href="{{ route('teacher.student-analytics', ['class_id' => $class->id, 'year' => $selectedYear, 'term' => $selectedTerm]) }}" 
        ...
        <div class="col-span-full bg-yellow-50 border border-yellow-200 rounded-xl p-8 text-center">
            ...
            <p class="text-yellow-700 font-medium">No classes found</p>
            <p class="text-yellow-600 text-sm mt-1">You are not assigned to any classes yet.</p>
        </div>
        @endforelse
    </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
        ...
        <a href="{{ route('teacher.student-analytics', ['class_id' => $selectedClassId, 'student_id' => $student->id, 'year' => $selectedYear, 'term' => $selectedTerm]) }}" 
    ...
    <div class="mb-6">
        <a href="{{ route('teacher.student-analytics', ['class_id' => $selectedClassId, 'year' => $selectedYear, 'term' => $selectedTerm]) }}" 
