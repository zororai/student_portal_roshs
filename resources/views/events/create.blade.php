        ...
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex items-center justify-between mb-8">
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-500">Add a new school event for parents and students</p>
                </div>
                    ...
                    <div class="px-6 py-6 space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input name="event_date" type="date" value="{{ old('event_date') }}" required
                                       class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-colors duration-200">
                ...
                <div class="bg-white rounded-2xl shadow-lg overflow-hidden mb-6">
                    ...
                    <div class="px-6 py-6">
                        <label class="flex items-center p-4 rounded-xl border-2 border-gray-200 hover:border-green-300 hover:bg-green-50 cursor-pointer transition-all duration-200">
                            <input type="checkbox" name="is_published" class="w-5 h-5 text-green-600 border-gray-300 rounded focus:ring-green-500">
                            <div class="ml-4">
                                <p class="text-sm font-semibold text-gray-900">Publish Immediately</p>
                                <p class="text-xs text-gray-500">Event will be visible to all users right away</p>
                            </div>
                        </label>
                    </div>
                </div>
