...
<div class="min-h-screen bg-gray-50 py-8">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex items-center justify-between mb-8">
            <div>
                <h1 class="text-3xl font-bold text-gray-900">Record Usage</h1>
                <p class="mt-1 text-gray-500">Deduct stock for daily usage</p>
            </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            <form action="{{ route('admin.grocery-stock.store-usage') }}" method="POST">
                @csrf
                ...
                <div class="mb-6">
                    ...
                    <input type="text" name="description" class="w-full px-4 py-2 border border-gray-300 rounded-lg" placeholder="e.g. Weekly usage for Week 3">
                </div>
                        ...
                        <div class="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <input type="number" name="items[{{ $index }}][quantity]" value="0" min="0" step="0.01" 
                                       class="w-24 px-3 py-2 border border-gray-300 rounded-lg text-right focus:ring-blue-500 focus:border-blue-500">
