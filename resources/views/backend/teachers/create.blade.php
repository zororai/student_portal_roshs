...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="mb-6 bg-blue-50 border-l-4 border-blue-400 p-4 rounded-r-lg">
        <div class="flex items-start">
            ...
            <div>
                <p class="text-sm text-blue-700"><strong>Default Password:</strong> The teacher will be assigned a default password of <code class="bg-blue-100 px-2 py-0.5 rounded">12345678</code></p>
