...
<div class="container-fluid px-4 py-6">
    <div class="max-w-2xl mx-auto">
        <div class="flex items-center mb-6">
            ...
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Add Non-Teaching Staff</h1>
                <p class="text-gray-600 mt-1">Add a new driver, accountant, or other staff member</p>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            ...
            <form action="{{ route('admin.non-teaching-staff.store') }}" method="POST" class="p-6 space-y-6">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="date" id="date_hired" name="date_hired" value="{{ old('date_hired', date('Y-m-d')) }}"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                    </div>
