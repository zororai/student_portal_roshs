...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-3xl font-bold text-gray-900">My Class Students</h1>
                <p class="mt-2 text-sm text-gray-600">{{ $class->class_name }} - {{ $students->count() }} students</p>
            </div>
            <a href="{{ route('teacher.class-attendance') }}" class="inline-flex items-center px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium rounded-lg transition-colors">
