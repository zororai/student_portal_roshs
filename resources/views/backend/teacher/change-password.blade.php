    ...
    <div class="max-w-md w-full">
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-blue-600 to-indigo-600 px-8 py-10 text-center">
                ...
                <h2 class="text-2xl font-bold text-white">Change Your Password</h2>
                <p class="text-blue-100 mt-2">Please create a new secure password</p>
            </div>

            <!-- Alert Message -->
            @if(session('warning'))
            <div class="mx-6 mt-6 bg-amber-50 border-l-4 border-amber-400 p-4 rounded-r-lg">
            ...
            <!-- Form -->
            <form method="POST" action="{{ route('teacher.update-password') }}" class="px-8 py-8 space-y-6">
                @csrf
                ...
                <div>
                    ...
                    @enderror
                    <p class="mt-1 text-xs text-gray-500">Default password is: 12345678</p>
                </div>
