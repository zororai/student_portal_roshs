...
<div class="container">
    ...
    <br>
    <h4 class="text-lg font-bold text-gray-700"> Subject Name {{ $result->subject->name }}</h4>
<br>
<br>
    <form action="{{ route('results.update', $result->id) }}" method="POST">
        ...
        <div class="mb-4">
            <label for="score" class="block text-gray-700">Mark</label>
            <input type="number" name="score" id="score" value="{{ $result->marks}}" class="form-control" required>
        </div>
