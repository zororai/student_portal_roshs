...
<div class="container-fluid px-4 py-6">
    <div class="mb-6">
        <div class="flex items-center mb-2">
            ...
            <h1 class="text-2xl font-bold text-gray-800">Text Content</h1>
        </div>
        <p class="text-gray-600">Edit website text content including about section, vision, mission, and more</p>
    </div>
            ...
            <div class="p-6 space-y-6">
                ...
                <div class="border-b border-gray-200 pb-6 last:border-0 last:pb-0">
                    ...
                    @if($setting->type === 'textarea')
                        ...
                        <p class="text-xs text-gray-400 mt-1">{{ strlen($setting->value) }} characters</p>
                    @else
                        <input 
                            type="text" 
                            name="{{ $setting->key }}" 
